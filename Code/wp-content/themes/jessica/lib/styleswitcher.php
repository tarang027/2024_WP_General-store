...
function style_switcher() { ?>
    <div class="theme-feature hidden-xs hidden-sm hidden-md">
		<div class="buttontoggler"><i class="fas fa-cog"></i></div>
		<div class="spanel">
			...
			<form name="styleswitcher" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="post">
				...
				<button type="button" id="resetpreview" class="tx-ctm-btn">Reset</button>
				<div class="presets">
					<h3>Color Switcher</h3>
					<ul id="preset" class="preset">
						<li><a class="preset1" href="?preset=1">Color 1</a></li>
						<li><a class="preset2" href="?preset=2">Color 2</a></li>
						<li><a class="preset3" href="?preset=3">Color 3</a></li>
						<li><a class="preset4" href="?preset=4">Color 4</a></li>
					</ul>
				</div>
			</form>
		</div>
...
if( isset($tx_ctm_opt['enable_sswitcher']) ) {
