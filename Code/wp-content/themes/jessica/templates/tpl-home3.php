...
genesis_structural_wrap( 'site-inner' );
  ...
  genesis_widget_area(
    'home3-page-service', array(
      'before' => '<div class="service-block"><div class="container"><div class="service-block-inner">',
      'after'  => '</div></div></div>',
    )
  );
  ...
  genesis_widget_area(
    'home-page-8', array(
      'before' => '<section class="specialproduct-section pt-100 pb-130"><div class="container">',
      'after'  => '</div></section>',
    )
  );
