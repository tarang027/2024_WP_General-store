...
class VI_SCT_SALES_COUNTDOWN_TIMER_Frontend_Shortcode_Checkout_Countdown {
	...
	public function woo_sctr_set_session_on_cart_page() {
		...
		$cart_subtotal_start                = apply_filters( 'wmc_3rd_change_price', $cart_subtotal_start );
		$wc_cart                            = WC()->cart;
...
//        $discount_fixed=apply_filters('wmc_3rd_change_price',$discount_fixed);
//        $original_cart_total = apply_filters('wmc_3rd_change_price',$original_cart_total);
		$minimum_cart_total  = apply_filters( 'wmc_3rd_change_price', $minimum_cart_total );
