...
//        $cart_subtotal_start=apply_filters('wmc_3rd_change_price',$cart_subtotal_start);
	...
	public static function checkout_countdown( $position = '', $page = '' ) {
		...
		if ( $session_countdown_check === 'yes' && $session_countdown_time ) {
			...
			$checkout_shortcode = '[sctv_checkout_countdown_timer sale_countdown_id="' . $sale_countdown_id . '"  time_end ="' . $session_countdown_end . '" checkout_inline ="' . $checkout_inline . '" message="' . $checkout_message . '" ]';
