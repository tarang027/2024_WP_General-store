...
//			'sale_countdown_archive_page_show'                     => array( '' ),
...
//		$check_t = get_option( 'sales_countdown_timer_params' );
		if ( ! empty( $woo_ctr_settings ) && ( ! isset( $woo_ctr_settings['sale_countdown_id'] ) || ! is_array( $woo_ctr_settings['sale_countdown_id'] ) || ! count( $woo_ctr_settings['sale_countdown_id'] ) ) ) {
			$args = array();
			if ( $woo_ctr_settings['id'] && is_array( $woo_ctr_settings['id'] ) && count( $woo_ctr_settings['id'] ) ) {
				$args['sale_countdown_id']             = $woo_ctr_settings['id'];
				$args['sale_countdown_active']         = $woo_ctr_settings['active'];
				$args['sale_countdown_name']           = $woo_ctr_settings['names'];
				$args['sale_countdown_message']        = $woo_ctr_settings['message'];
				$args['sale_countdown_fom_date']       = $woo_ctr_settings['sale_from_date'];
				$args['sale_countdown_fom_time']       = $woo_ctr_settings['sale_from_time'];
				$args['sale_countdown_to_date']        = $woo_ctr_settings['sale_to_date'];
				$args['sale_countdown_to_time']        = $woo_ctr_settings['sale_to_time'];
				$args['sale_countdown_time_separator'] = $woo_ctr_settings['time_separator'];
				foreach ( $woo_ctr_settings['display_type'] as $item ) {
					if ( $item == 2 ) {
						$args['sale_countdown_display_type'][] = '1';
					} elseif ( $item == 1 ) {
						$args['sale_countdown_display_type'][] = '2';
					} else {
						$args['sale_countdown_display_type'][] = $item;
					}
				}
				$args['sale_countdown_datetime_format']                       = $woo_ctr_settings['count_style'];
				$args['sale_countdown_upcoming_enable']                       = $woo_ctr_settings['upcoming'];
				$args['sale_countdown_upcoming_message']                      = $woo_ctr_settings['upcoming_message'];
				$args['sale_countdown_single_product_position']               = $woo_ctr_settings['position'];
				$args['sale_countdown_archive_page_position']                 = $woo_ctr_settings['archive_page_position'];
				$args['sale_countdown_progress_bar_message']                  = $woo_ctr_settings['progress_bar_message'];
				$args['sale_countdown_progress_bar_type']                     = $woo_ctr_settings['progress_bar_type'];
				$args['sale_countdown_progress_bar_order_status']             = $woo_ctr_settings['progress_bar_order_status'];
				$args['sale_countdown_progress_bar_position']                 = $woo_ctr_settings['progress_bar_position'];
				$args['sale_countdown_progress_bar_template_1_width']         = $woo_ctr_settings['progress_bar_width'];
				$args['sale_countdown_progress_bar_template_1_height']        = $woo_ctr_settings['progress_bar_height'];
				$args['sale_countdown_progress_bar_template_1_color']         = $woo_ctr_settings['progress_bar_color'];
				$args['sale_countdown_progress_bar_template_1_background']    = $woo_ctr_settings['progress_bar_bg_color'];
				$args['sale_countdown_progress_bar_template_1_border_radius'] = $woo_ctr_settings['progress_bar_border_radius'];
				$args['sale_countdown_template_1_time_unit_background']       = $woo_ctr_settings['datetime_unit_bg_color'];
				$args['sale_countdown_template_2_time_unit_background']       = $woo_ctr_settings['datetime_unit_bg_color'];
				$args['sale_countdown_template_3_time_unit_background']       = $woo_ctr_settings['datetime_unit_bg_color'];
				$args['sale_countdown_template_4_time_unit_background']       = $woo_ctr_settings['datetime_unit_bg_color'];
				$args['sale_countdown_template_1_time_unit_color']            = $woo_ctr_settings['datetime_unit_color'];
				$args['sale_countdown_template_2_time_unit_color']            = $woo_ctr_settings['datetime_unit_color'];
				$args['sale_countdown_template_3_time_unit_color']            = $woo_ctr_settings['datetime_unit_color'];
				$args['sale_countdown_template_4_time_unit_color']            = $woo_ctr_settings['datetime_unit_color'];
				$args['sale_countdown_template_1_time_unit_fontsize']         = $woo_ctr_settings['datetime_unit_font_size'];
				$args['sale_countdown_template_2_time_unit_fontsize']         = $woo_ctr_settings['datetime_unit_font_size'];
				$args['sale_countdown_template_3_time_unit_fontsize']         = $woo_ctr_settings['datetime_unit_font_size'];
				$args['sale_countdown_template_4_time_unit_fontsize']         = $woo_ctr_settings['datetime_unit_font_size'];
				$args['sale_countdown_template_1_value_color']                = $woo_ctr_settings['datetime_value_color'];
				$args['sale_countdown_template_2_value_color']                = $woo_ctr_settings['datetime_value_color'];
				$args['sale_countdown_template_3_value_color']                = $woo_ctr_settings['datetime_value_color'];
				$args['sale_countdown_template_4_value_color']                = $woo_ctr_settings['datetime_value_color'];
				$args['sale_countdown_template_1_value_background']           = $woo_ctr_settings['datetime_value_bg_color'];
				$args['sale_countdown_template_2_value_background']           = $woo_ctr_settings['datetime_value_bg_color'];
				$args['sale_countdown_template_3_value_background']           = $woo_ctr_settings['datetime_value_bg_color'];
				$args['sale_countdown_template_4_value_background']           = $woo_ctr_settings['datetime_value_bg_color'];
				$args['sale_countdown_template_1_value_font_size']            = $woo_ctr_settings['datetime_value_font_size'];
				$args['sale_countdown_template_2_value_fontsize']             = $woo_ctr_settings['datetime_value_font_size'];
				$args['sale_countdown_template_3_value_fontsize']             = $woo_ctr_settings['datetime_value_font_size'];
				$args['sale_countdown_template_4_value_fontsize']             = $woo_ctr_settings['datetime_value_font_size'];
				$args['sale_countdown_layout_1_padding']                      = $woo_ctr_settings['countdown_timer_padding'];
				$args['sale_countdown_layout_1_border_radius']                = $woo_ctr_settings['countdown_timer_border_radius'];
				$args['sale_countdown_layout_1_color']                        = $woo_ctr_settings['countdown_timer_color'];
				$args['sale_countdown_layout_1_background']                   = $woo_ctr_settings['countdown_timer_bg_color'];
				$args['sale_countdown_layout_1_border_color']                 = $woo_ctr_settings['countdown_timer_border_color'];
				$args['sale_countdown_template_1_value_border_radius']        = $woo_ctr_settings['countdown_timer_item_border_radius'];
				$args['sale_countdown_template_2_item_border_radius']         = $woo_ctr_settings['countdown_timer_item_border_radius'];
				$args['sale_countdown_template_1_value_border_color']         = $woo_ctr_settings['countdown_timer_item_border_color'];
				$args['sale_countdown_template_2_item_border_color']          = $woo_ctr_settings['countdown_timer_item_border_color'];
				$args['sale_countdown_template_4_value_border_color2']        = $woo_ctr_settings['countdown_timer_item_border_color'];
				$args['sale_countdown_template_1_value_height']               = $woo_ctr_settings['countdown_timer_item_height'];
				$args['sale_countdown_template_2_item_height']                = $woo_ctr_settings['countdown_timer_item_height'];
				$args['sale_countdown_template_1_value_width']                = $woo_ctr_settings['countdown_timer_item_width'];
				$args['sale_countdown_template_2_item_width']                 = $woo_ctr_settings['countdown_timer_item_width'];
				$args['sale_countdown_template_1_time_unit_position']         = $woo_ctr_settings['datetime_unit_position'];
				$args['sale_countdown_template_2_time_unit_position']         = $woo_ctr_settings['datetime_unit_position'];
				$args['sale_countdown_template_4_time_unit_position']         = $woo_ctr_settings['datetime_unit_position'];
				$args['sale_countdown_loop_resize']                           = $woo_ctr_settings['size_on_archive_page'];
				$args['sale_countdown_circle_smooth_animation']               = $woo_ctr_settings['circle_smooth_animation'];
				$args['sale_countdown_animation_style']                       = $woo_ctr_settings['animation_style'];
				foreach ( $woo_ctr_settings['stick_to_top'] as $k => $value ) {
					$args['sale_countdown_single_product_sticky'] [] = isset( $woo_ctr_settings['stick_to_top'][ $k ] ) ? 'sticky_top' : 'none';
				}
				...
				for ( $i = 0; $i < count( $shop_page ); $i ++ ) {
					...
					$args['sale_countdown_archive_page_enable'][ $i ]          = $archive_page ? '1' : '';
					$args['sale_countdown_archive_page_show'][ $i ]            = trim( $archive_page, ',' );
					$args['sale_countdown_upcoming_progress_bar_enable'][ $i ] = '1';
				}

				set_transient( '_sales_countdown_timer_set_schedule',
					current_time( 'timestamp' ),
					180 * DAY_IN_SECONDS );
			}
			$args = wp_parse_args( $args, get_option( 'sales_countdown_timer_params', $this->default ) );
//			if ( ! $woo_ctr_settings ) {
			$woo_ctr_settings = $args;
//			}
			update_option( 'sales_countdown_timer_params', $args );
			set_transient( '_sales_countdown_timer_demo_product_init',
				current_time( 'timestamp' ),
				180 * DAY_IN_SECONDS );

		}
		if (!empty($woo_ctr_settings) && !empty($woo_ctr_settings['sale_countdown_archive_page_show']) && empty($woo_ctr_settings['sale_countdown_archive_page_assign'])){
			$args=$sale_countdown_archive_page_assign=array();
			...
			$args['sale_countdown_archive_page_assign'] = $sale_countdown_archive_page_assign;
			$args = wp_parse_args( $args, get_option( 'sales_countdown_timer_params', $this->default ) );
			$woo_ctr_settings = $args;
			update_option( 'sales_countdown_timer_params', $args );
		}
	...
	public function get_current_countdown( $name = "", $i = 0 ) {
		$result = isset( $this->get_params( $name )[ $i ] ) ? $this->get_params( $name )[ $i ] : $this->get_default( $name )[0];
