...
class VI_SCT_SALES_COUNTDOWN_TIMER_Admin_Checkout_Report {
	...
	public function admin_enqueue_scripts() {
		...
		if ( $page === 'sales-countdown-timer-checkout-report' ) {
			...
			wp_enqueue_style( 'vi-sct-checkout-report-dropdown', VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'dropdown.min.css' );
			wp_enqueue_style( 'vi-sct-checkout-report-menu', VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'menu.min.css' );
			wp_enqueue_style( 'vi-sct-checkout-report-transition', VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'transition.min.css' );
			wp_enqueue_style( 'vi-sct-checkout-report-css', VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'admin-checkout-report.css' );
			wp_enqueue_script( 'jquery-ui-datepicker' );
			wp_enqueue_script( 'vi-sct-checkout-report-chart', VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'chart.min.js', array( 'jquery' ) );
			wp_enqueue_script( 'vi-sct-checkout-report-dropdown', VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'dropdown.min.js', array( 'jquery' ) );
			wp_enqueue_script( 'vi-sct-checkout-report-transition', VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'transition.min.js', array( 'jquery' ) );
			wp_enqueue_script( 'vi-sct-checkout-report-js', VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'admin-checkout-report.js', array( 'jquery' ) );
			$args = array(
				'subpage'              => $subpage,
