...
class VI_SCT_SALES_COUNTDOWN_TIMER_Admin_Checkout_Settings {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_sctv_search_product_free', array( $this, 'sctv_search_product_free' ) );
	...
	public function sctv_search_product_free() {
	...
	public function save_checkout_countdown_settings() {
		...
		foreach ( $args as $item_key => $item_arg ) {
			if ( in_array( $item_key,
				...
				$args[ $item_key ] = isset( $_POST[ $item_key ] ) ? array_map( 'sanitize_text_field',
					$_POST[ $item_key ] ) : array();
	...
	public function admin_enqueue_scripts() {
		...
		if ( $page === 'sales-countdown-timer-checkout' ) {
			...
			/*Stylesheet*/
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-button',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'button.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-checkbox',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'checkbox.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-dropdown',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'dropdown.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-form',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'form.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-icon',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'icon.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-menu',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'menu.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-message',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'message.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-segment',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'segment.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-label',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'label.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-transition',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'transition.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-accordion',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'accordion.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-input',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'input.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-header',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'header.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-popup',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'popup.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-select2',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'select2.min.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-tab',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'tab.css',
				'',
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );

			wp_enqueue_style( 'vi-sales-countdown-timer-admin-checkout-css',
				VI_SCT_SALES_COUNTDOWN_TIMER_CSS . 'admin-checkout.css',
				array(),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			...
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-checkbox',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'checkbox.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-dropdown',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'dropdown.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-form',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'form.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-tab',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'tab.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-select2',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'select2.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-transition',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'transition.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-accordion',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'accordion.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-address',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'address.min.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );

			wp_enqueue_script( 'vi-sales-countdown-timer-admin-checkout-js',
				VI_SCT_SALES_COUNTDOWN_TIMER_JS . 'admin-checkout.js',
				array( 'jquery' ),
				VI_SCT_SALES_COUNTDOWN_TIMER_VERSION );
