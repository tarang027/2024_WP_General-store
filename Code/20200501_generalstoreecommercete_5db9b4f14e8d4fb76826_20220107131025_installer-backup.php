...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200501_generalstoreecommercete_5db9b4f14e8d4fb76826_20220107131025_archive.zip';
	const ARCHIVE_SIZE		 = '69283063';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5db9b4f-07131025';
    const SECONDARY_PACKAGE_HASH = '102892b-07131025';
	const VERSION			 = '1.4.3';
